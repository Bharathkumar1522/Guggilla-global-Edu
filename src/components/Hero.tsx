      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10 w-full max-w-full">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center max-w-7xl mx-auto">
          ...
          <div className="text-center lg:text-left w-full">
            <h1 className="hero-title text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-secondary-900 mb-6 leading-tight break-words">
              Guggilla Global
            ...
            <h2 className="hero-subtitle text-lg sm:text-xl md:text-2xl text-secondary-700 mb-4 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-semibold break-words">
              Your Study Abroad Journey Begins Here
            </h2>

            <p className="hero-tagline text-base sm:text-lg md:text-xl text-secondary-600 mb-6 max-w-2xl mx-auto lg:mx-0 break-words">
              A newly launched consultancy helping Indian students study in the UK and beyond.
            </p>

            {/* Trust building caption */}
            <div className="flex items-center justify-center lg:justify-start gap-2 mb-8 flex-wrap">
              <Star className="text-yellow-500 fill-current flex-shrink-0" size={20} />
              <span className="text-sm text-secondary-600 italic">We're new, but dedicated to your success</span>
            </div>

            <div className="hero-buttons flex flex-col sm:flex-row gap-4 justify-center lg:justify-start items-center mb-16 w-full">
              <button 
                onClick={() => handleWhatsAppClick('india')}
                className="animated-button flex items-center justify-center gap-3 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white px-4 sm:px-6 lg:px-8 py-3 sm:py-4 rounded-full font-semibold text-sm sm:text-base lg:text-lg transition-all duration-300 shadow-lg hover:shadow-xl w-full sm:w-auto max-w-full"
              >
              ...
              <button 
                ...
                className="animated-button flex items-center justify-center gap-3 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-4 sm:px-6 lg:px-8 py-3 sm:py-4 rounded-full font-semibold text-sm sm:text-base lg:text-lg transition-all duration-300 shadow-lg hover:shadow-xl w-full sm:w-auto max-w-full"
              >
                <MessageCircle size={20} className="flex-shrink-0" />
          ...
          <div className="hero-image relative w-full">
            <div className="relative overflow-hidden rounded-3xl shadow-2xl max-w-full">
              <img 
                ...
                className="w-full h-[300px] sm:h-[400px] lg:h-[500px] xl:h-[600px] object-cover max-w-full"
              />
              ...
              <div className="absolute top-4 sm:top-6 right-4 sm:right-6 bg-white/95 backdrop-blur-sm rounded-2xl p-3 sm:p-4 shadow-lg max-w-[calc(100%-2rem)]">
                <div className="flex items-center gap-2">
                  <div className="w-3 h-3 bg-green-500 rounded-full animate-pulse flex-shrink-0"></div>
                  <span className="text-xs sm:text-sm font-semibold text-secondary-700 truncate">100% Visa Success*</span>
                </div>
              </div>
              
              {/* Bottom info card */}
              <div className="absolute bottom-4 sm:bottom-6 left-4 sm:left-6 bg-white/95 backdrop-blur-sm rounded-2xl p-3 sm:p-4 shadow-lg max-w-[calc(100%-2rem)]">
                <div className="flex items-center gap-3">
                  <GraduationCap className="text-blue-500 flex-shrink-0" size={20} />
                  <div className="min-w-0">
                    <p className="text-xs sm:text-sm font-semibold text-secondary-900 truncate">30+ Universities</p>
